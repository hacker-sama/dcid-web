"""Quản lý Prompt Templates cho Qwen2-VL-2B (Vision Captioner) và Main LLM (RAG Reasoning)."""
...
# ────────────────────────────────────────────────────────────────────────────
# Do Qwen2-VL-2B Q4_K_M bị giới hạn lý luận phức tạp, ta bắt nó làm các task
# cụ thể, mang tính mô tả trực tiếp để chuyển đổi Hình ảnh -> Text chi tiết.
