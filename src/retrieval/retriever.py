...
def retrieve_context(
    ...
    Returns:
        (hits, citations)
        citations chứa thông tin page_no, bbox, và ĐẶC BIỆT LÀ `image_path` để Frontend UI render ảnh crop!
    """
    ...
    for hit in hits:
        citations.append({
            ...
            "bbox": hit.get("bbox", ""),
            "imagePath": hit.get("image_path", ""),  # FRONTEND UI RENDER ẢNH CROP MÀN HÌNH
