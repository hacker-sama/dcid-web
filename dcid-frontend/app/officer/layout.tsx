...
const NAV_ITEMS = [
  { name: "Tổng quan KPI", href: ROUTES.OFFICER.DASHBOARD, icon: LayoutDashboard },
  { name: "Hàng đợi hồ sơ", href: ROUTES.OFFICER.APPLICATIONS, icon: FileText },
  { name: "Quản lý thủ tục", href: ROUTES.OFFICER.PROCEDURES, icon: FileSearch },
  { name: "Quản lý người dùng", href: ROUTES.OFFICER.USERS, icon: Users },
  { name: "Báo cáo thống kê", href: ROUTES.OFFICER.REPORTS, icon: BarChart },
  { name: "Nhật ký hệ thống", href: ROUTES.OFFICER.AUDIT_LOG, icon: History },
];
    ...
    <div className="min-h-screen bg-muted/20 flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r bg-card h-screen sticky top-0">
        <div className="p-6 border-b">
          <Link href={ROUTES.OFFICER.DASHBOARD} className="flex items-center gap-2 text-primary">
            <Shield className="h-8 w-8" />
            <div>
              <span className="font-bold text-xl tracking-tight block leading-tight">DCID</span>
              <span className="text-xs font-medium text-muted-foreground">Officer Portal</span>
            </div>
          </Link>
        </div>
        ...
        <header className="md:hidden flex items-center justify-between p-4 border-b bg-card sticky top-0 z-10">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-lg leading-tight text-primary">DCID</span>
              <span className="text-[10px] font-medium text-muted-foreground leading-none">Officer</span>
            </div>
          </div>
